---
title: "Vaatlejate eelraport: valimissaladus algavatel KOV valimistel pole tagatud"
...
> "Kui toimub oluliste turvareeglite rikkumine, siis pole valimiste korraldajal enam võimalik tõrjuda kriitikat põhjendusega, et kuna järgisime reegleid, siis peavad manipulatsiooni asetleidmist tõendama valimisvaatlejad," ütles MTÜ Ausad Valimised juhatuse liige Märt Põder. "Praeguses olukorras lasub tõenduskoorem Arne Koitmäe õlgadel, kes oma 6. oktoobri vastustes vaatlejate puuduste avaldustele ei suutnud põhjendada, kuidas häälte avamise võtme ja seega valimissaladuse kompromiteerimine ületatakse."

> "Tuletame meelde, et n-n kuldvõtmekese protseduur on elektroonilise hääletuse enim reklaamitud turvaelement, mis peaks tõendama kogu protsessi terviklust, ja nagu näha 2024. aasta videoülesvõttest, on võtme avamine, kasutamine ja pitseerimine võrdlemisi lihtne toiming," ütles Tallinna Tehnikaülikooli küberneetika instituudi juhtivteadur Ago Samoson. "Ometi kukuvad vastutavad asutused piinlikult läbi ka selles lihtsas toimingus, mille rikkumine ise on pigem väljakutse, käitudes nagu tavalised taskuvargad."
